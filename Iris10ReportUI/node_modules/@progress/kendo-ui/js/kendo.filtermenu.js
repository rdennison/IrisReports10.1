...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function(f, define){
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1122), __webpack_require__(1138), __webpack_require__(1010), __webpack_require__(1060) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (f), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	})(function(){
	                        ...
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    ...
	                                    '<select class="k-filter-operator" data-#=ns#bind="value: filters[0].operator">' +
	                                        '#for(var op in operators){#' +
	                                            '<option value="#=op#">#=operators[op]#</option>' +
	                                        '#}#' +
	                                    '</select>' +
	                            ...
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    ...
	                                    '#if(values){#' +
	                                        ...
	                                        '</select>' +
	                                    '#}else{#' +
	                                        '<input data-#=ns#bind="value:filters[0].value" class="k-value-input" type="#=inputType#"  />' +
	                                    '#}#' +
	                                '</label>' +
	                            '</li>' +
	                        '</ul>' +
	                        ...
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    ...
	                                    '<input type="radio" id="#=andGuid#" name="logic" class="k-radio" data-#=ns#bind="checked: logic" value="and" />' +
	                                    '<label class="k-radio-label" for="#=andGuid#"></label>' +
	                                '</label>' +
	                            '</li>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    '<span class="k-filter-logic-or-text">#=messages.or#</span>' +
	                                    '<input type="radio" id="#=orGuid#" name="logic" class="k-radio" data-#=ns#bind="checked: logic" value="or" />' +
	                                    '<label class="k-radio-label" for="#=orGuid#"></label>' +
	                                '</label>' +
	                            '</li>' +
	                        '</ul>' +
	                        '<ul>' +
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    ...
	                                    '<select class="k-filter-operator" data-#=ns#bind="value: filters[1].operator">' +
	                                        '#for(var op in operators){#' +
	                                            '<option value="#=op#">#=operators[op]#</option>' +
	                                        '#}#' +
	                                    '</select>' +
	                            ...
	                            '<li class="k-item">' +
	                                '<label class="k-label">' +
	                                    ...
	                                    '#if(values){#' +
	                                        ...
	                                        '</select>' +
	                                    '#}else{#' +
	                                        '<input data-#=ns#bind="value:filters[1].value" class="k-value-input" type="#=inputType#" />' +
	                                    '#}#' +
	                                '</label>' +
	                            '</li>' +
	                        '</ul>' +
	                    ...
	                    '<li>' +
	                        ...
	                        '<ul class="k-multicheck-bool-wrap">' +
	                            ...
	                            '<li class="k-item"><label class="k-label">' +
	                                ...
	                                '<span class="k-item-title">#=messages.isFalse#</span>' +
	                            '</label></li>' +
	                        '</ul>'+
	                    '</li>'+
	                    '<li class="k-item">' +
