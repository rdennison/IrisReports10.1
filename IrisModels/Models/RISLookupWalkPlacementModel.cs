...
{
    //[IrisGrid("~/API/RISLookupWalkPlacement/Read", "~/API/RISLookupWalkPlacement/Create", "~/API/RISLookupWalkPlacement/Update", "~/API/RISLookupWalkPlacement/Destroy")]
    public sealed class RISLookupWalkPlacementModel : ModelBase
    {
		[Key]
