...
{
    //[IrisGrid("~/API/RISLookupCulvertMaterial/Read", "~/API/RISLookupCulvertMaterial/Create", "~/API/RISLookupCulvertMaterial/Update", "~/API/RISLookupCulvertMaterial/Destroy")]
    public sealed class RISLookupCulvertMaterialModel : ModelBase
    {
		[Key]
