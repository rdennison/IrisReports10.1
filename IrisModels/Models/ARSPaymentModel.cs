...
{
    [Report(Module = "Accounts Receivable", Display = "Payment History", ListValue = "ARSPayment")]
    [Security(Module = "Accounts Receivable", Display = "Payment History", ListValue = "ARSPayment")]
    public sealed class ARSPaymentModel : ModelBase
    {
		[Key]
