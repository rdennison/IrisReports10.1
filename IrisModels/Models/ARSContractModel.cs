...
{
    [Report(Module = "Accounts Receivable", Display = "ARS Contract", ListValue = "ARSContract")]
    [Security(Module = "Accounts Receivable", Display = "ARS Contract", ListValue = "ARSContract")]
    public sealed class ARSContractModel : ModelBase
    {
		[Key]
