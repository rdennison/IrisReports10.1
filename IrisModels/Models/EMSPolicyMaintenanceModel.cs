...
{
    //[IrisGrid("~/API/EMSPolicyMaintenance/Read", "~/API/EMSPolicyMaintenance/Create", "~/API/EMSPolicyMaintenance/Update", "~/API/EMSPolicyMaintenance/Destroy")]
    public sealed class EMSPolicyMaintenanceModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 153)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IsExcludeSql]
		[FilterType(Text = true)]
