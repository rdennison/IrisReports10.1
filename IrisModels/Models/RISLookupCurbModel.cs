...
{
    //[IrisGrid("~/API/RISLookupCurb/Read", "~/API/RISLookupCurb/Create", "~/API/RISLookupCurb/Update", "~/API/RISLookupCurb/Destroy")]
    public sealed class RISLookupCurbModel : ModelBase
    {
		[Key]
