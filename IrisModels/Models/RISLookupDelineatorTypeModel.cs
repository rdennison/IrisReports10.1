...
{
    //[IrisGrid("~/API/RISLookupDelineatorType/Read", "~/API/RISLookupDelineatorType/Create", "~/API/RISLookupDelineatorType/Update", "~/API/RISLookupDelineatorType/Destroy")]
    public sealed class RISLookupDelineatorTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupDelineatorType_Key { get; set; }
