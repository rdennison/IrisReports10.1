...
{
    [Report(Module = "Accounts Payable", Display = "Payable Transaction", ListValue = "APSTransact")]
    [Security(Module = "Accounts Payable", Display = "Payable Transaction", ListValue = "APSTransact")]
    [IrisGridColumn(ScreenName = "PayableTransaction")]
    public sealed class APSTransactModel : ModelBase
    {
		[Key]
