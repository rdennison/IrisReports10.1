...
{
    //[IrisGrid("~/API/RISSignHistoryAction/Read", "~/API/RISSignHistoryAction/Create", "~/API/RISSignHistoryAction/Update", "~/API/RISSignHistoryAction/Destroy")]
    public sealed class RISSignHistoryActionModel : ModelBase
    {
		[Key]
