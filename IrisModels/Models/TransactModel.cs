...
{
    [Report(Module = "Cost Accounting", Display = "Transaction", ListValue = "Transact")]
    [Security(Module = "Cost Accounting", Display = "Transaction", ListValue = "Transact")]
    [LookupDisplay(Name = "CAS - Transaction")]
    public sealed class TransactModel : ModelBase
    {
		[Key]
		...
		[DataType("Byte")]
		[Display(Name = "Posted From APS")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public byte? PostedFromAPS { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.TinyInt)]
		[DataType("Byte")]
		[Display(Name = "Export ARS Deleted")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public byte? ExportARSDeleted { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 33, Scale = 12)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Employee Hourly Rate With Premium")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? EmployeeHourlyRateWithPremium { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Employee Hourly Rate With Premium Pay Factor")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? EmployeeHourlyRateWithPremiumPayFactor { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 32, Scale = 12)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Pemium Hourly Rate")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? PemiumHourlyRate { get; set; }
		...
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalClassCost { get; set; }
		...
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total Labor With Fringe OH")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalLaborWithFringeOH { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total Labor Without Fringe OH")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalLaborWithoutFringeOH { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total Labor Without Fringe OH Other")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalLaborWithoutFringeOHOther { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total Labor Without OH")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalLaborWithoutOH { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total OH With Fringe")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalOHWithFringe { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Decimal, Precision = 38, Scale = 6)]
		[IsExcludeSql]
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total OH Without Fringe")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalOHWithoutFringe { get; set; }
		...
		[DataType("Integer")]
		[FilterType(Dropdown = true)]
		[Display(Name = "Posted By User Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public int? PostedByUser_Key { get; set; }
		...
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Total Labor Without OH Other")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? TotalLaborWithoutOHOther { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(TimeCardModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "Time Card Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
