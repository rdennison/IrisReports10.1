...
{
    [Report(Module = "Road Inventory", Display = "Levee", ListValue = "RISLevee")]
    [Security(Module = "Road Inventory", Display = "Levee", ListValue = "RISLevee")]
    [LookupDisplay(Name = "RIS - Levee")]
    public sealed class RISLeveeModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupLeveeBankPlacementModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Levee Bank Placement Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		...
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Average Protection Height")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? AverageProtectionHeight { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.NChar, Size = 10)]
		[FilterType(Text = true)]
		[Display(Name = "User 9")]
		[IrisGridColumn(Width = 150)]
		[UserDefined]
