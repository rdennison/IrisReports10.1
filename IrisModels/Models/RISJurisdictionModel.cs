...
{
    [Report(Module = "Road Inventory", Display = "Jurisdiction", ListValue = "RISJurisdiction")]
    [Security(Module = "Road Inventory", Display = "Jurisdiction", ListValue = "RISJurisdiction")]
    public sealed class RISJurisdictionModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISJurisdiction_Key { get; set; }
