...
{
    [LookupDisplay(Name = "RIS - Culvert History")]
    public sealed class RISCulvertHistoryModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupCulvertHistoryActionModel), ForeignKeyDisplayField="NameDesc")]
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupCulvertHistoryDefectModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
