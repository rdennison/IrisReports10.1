...
{
    //[IrisGrid("~/API/RISLookupJurisdiction/Read", "~/API/RISLookupJurisdiction/Create", "~/API/RISLookupJurisdiction/Update", "~/API/RISLookupJurisdiction/Destroy")]
    public sealed class RISLookupJurisdictionModel : ModelBase
    {
		[Key]
