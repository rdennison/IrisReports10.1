...
{
    //[IrisGrid("~/API/RISLookupBridgeFeature/Read", "~/API/RISLookupBridgeFeature/Create", "~/API/RISLookupBridgeFeature/Update", "~/API/RISLookupBridgeFeature/Destroy")]
    public sealed class RISLookupBridgeFeatureModel : ModelBase
    {
		[Key]
