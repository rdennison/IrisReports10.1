...
{
    //[IrisGrid("~/API/RISLookupWallPosition/Read", "~/API/RISLookupWallPosition/Create", "~/API/RISLookupWallPosition/Update", "~/API/RISLookupWallPosition/Destroy")]
    public sealed class RISLookupWallPositionModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupWallPosition_Key { get; set; }
