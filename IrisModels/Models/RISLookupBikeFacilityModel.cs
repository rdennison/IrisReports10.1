...
{
    //[IrisGrid("~/API/RISLookupBikeFacility/Read", "~/API/RISLookupBikeFacility/Create", "~/API/RISLookupBikeFacility/Update", "~/API/RISLookupBikeFacility/Destroy")]
    public sealed class RISLookupBikeFacilityModel : ModelBase
    {
		[Key]
