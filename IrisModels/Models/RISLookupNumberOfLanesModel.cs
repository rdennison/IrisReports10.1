...
{
    //[IrisGrid("~/API/RISLookupNumberOfLanes/Read", "~/API/RISLookupNumberOfLanes/Create", "~/API/RISLookupNumberOfLanes/Update", "~/API/RISLookupNumberOfLanes/Destroy")]
    public sealed class RISLookupNumberOfLanesModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupNumberOfLanes_Key { get; set; }
