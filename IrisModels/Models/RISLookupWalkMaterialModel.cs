...
{
    //[IrisGrid("~/API/RISLookupWalkMaterial/Read", "~/API/RISLookupWalkMaterial/Create", "~/API/RISLookupWalkMaterial/Update", "~/API/RISLookupWalkMaterial/Destroy")]
    public sealed class RISLookupWalkMaterialModel : ModelBase
    {
		[Key]
