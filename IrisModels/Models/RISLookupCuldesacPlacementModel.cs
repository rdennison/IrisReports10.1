...
{
    //[IrisGrid("~/API/RISLookupCuldesacPlacement/Read", "~/API/RISLookupCuldesacPlacement/Create", "~/API/RISLookupCuldesacPlacement/Update", "~/API/RISLookupCuldesacPlacement/Destroy")]
    public sealed class RISLookupCuldesacPlacementModel : ModelBase
    {
		[Key]
