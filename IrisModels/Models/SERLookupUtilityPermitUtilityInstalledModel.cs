...
{
    //[IrisGrid("~/API/SERLookupUtilityPermitUtilityInstalled/Read", "~/API/SERLookupUtilityPermitUtilityInstalled/Create", "~/API/SERLookupUtilityPermitUtilityInstalled/Update", "~/API/SERLookupUtilityPermitUtilityInstalled/Destroy")]
    public sealed class SERLookupUtilityPermitUtilityInstalledModel : ModelBase
    {
		[Key]
