...
{
    //[IrisGrid("~/API/RISLookupMonumentPlacement/Read", "~/API/RISLookupMonumentPlacement/Create", "~/API/RISLookupMonumentPlacement/Update", "~/API/RISLookupMonumentPlacement/Destroy")]
    public sealed class RISLookupMonumentPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupMonumentPlacement_Key { get; set; }
