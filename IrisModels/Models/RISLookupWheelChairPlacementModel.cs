...
{
    //[IrisGrid("~/API/RISLookupWheelChairPlacement/Read", "~/API/RISLookupWheelChairPlacement/Create", "~/API/RISLookupWheelChairPlacement/Update", "~/API/RISLookupWheelChairPlacement/Destroy")]
    public sealed class RISLookupWheelChairPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupWheelChairPlacement_Key { get; set; }
