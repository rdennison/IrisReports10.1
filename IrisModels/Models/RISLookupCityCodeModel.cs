...
{
    //[IrisGrid("~/API/RISLookupCityCode/Read", "~/API/RISLookupCityCode/Create", "~/API/RISLookupCityCode/Update", "~/API/RISLookupCityCode/Destroy")]
    public sealed class RISLookupCityCodeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupCityCode_Key { get; set; }
