...
{
    //[IrisGrid("~/API/EMSLookupPartCategory/Read", "~/API/EMSLookupPartCategory/Create", "~/API/EMSLookupPartCategory/Update", "~/API/EMSLookupPartCategory/Destroy")]
    public sealed class EMSLookupPartCategoryModel : ModelBase
    {
		[Key]
