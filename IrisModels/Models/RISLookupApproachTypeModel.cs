...
{
    //[IrisGrid("~/API/RISLookupApproachType/Read", "~/API/RISLookupApproachType/Create", "~/API/RISLookupApproachType/Update", "~/API/RISLookupApproachType/Destroy")]
    public sealed class RISLookupApproachTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupApproachType_Key { get; set; }
