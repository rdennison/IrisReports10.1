...
{
    //[IrisGrid("~/API/RISLookupCulvertDrainage/Read", "~/API/RISLookupCulvertDrainage/Create", "~/API/RISLookupCulvertDrainage/Update", "~/API/RISLookupCulvertDrainage/Destroy")]
    public sealed class RISLookupCulvertDrainageModel : ModelBase
    {
		[Key]
