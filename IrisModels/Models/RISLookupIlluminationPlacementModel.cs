...
{
    //[IrisGrid("~/API/RISLookupIlluminationPlacement/Read", "~/API/RISLookupIlluminationPlacement/Create", "~/API/RISLookupIlluminationPlacement/Update", "~/API/RISLookupIlluminationPlacement/Destroy")]
    public sealed class RISLookupIlluminationPlacementModel : ModelBase
    {
		[Key]
