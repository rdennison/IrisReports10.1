...
{
    //[IrisGrid("~/API/RISLookupCatchBasinHistoryOutflowMaintenance/Read", "~/API/RISLookupCatchBasinHistoryOutflowMaintenance/Create", "~/API/RISLookupCatchBasinHistoryOutflowMaintenance/Update", "~/API/RISLookupCatchBasinHistoryOutflowMaintenance/Destroy")]
    public sealed class RISLookupCatchBasinHistoryOutflowMaintenanceModel : ModelBase
    {
		[Key]
