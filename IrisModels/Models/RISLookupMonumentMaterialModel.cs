...
{
    //[IrisGrid("~/API/RISLookupMonumentMaterial/Read", "~/API/RISLookupMonumentMaterial/Create", "~/API/RISLookupMonumentMaterial/Update", "~/API/RISLookupMonumentMaterial/Destroy")]
    public sealed class RISLookupMonumentMaterialModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupMonumentMaterial_Key { get; set; }
