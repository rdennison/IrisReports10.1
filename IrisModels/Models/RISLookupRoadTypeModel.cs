...
{
    //[IrisGrid("~/API/RISLookupRoadType/Read", "~/API/RISLookupRoadType/Create", "~/API/RISLookupRoadType/Update", "~/API/RISLookupRoadType/Destroy")]
    public sealed class RISLookupRoadTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupRoadType_Key { get; set; }
