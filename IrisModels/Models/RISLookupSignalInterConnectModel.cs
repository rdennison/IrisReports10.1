...
{
    //[IrisGrid("~/API/RISLookupSignalInterConnect/Read", "~/API/RISLookupSignalInterConnect/Create", "~/API/RISLookupSignalInterConnect/Update", "~/API/RISLookupSignalInterConnect/Destroy")]
    public sealed class RISLookupSignalInterConnectModel : ModelBase
    {
		[Key]
