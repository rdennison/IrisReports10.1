...
{
    //[IrisGrid("~/API/RISRoadClassAudit/Read", "~/API/RISRoadClassAudit/Create", "~/API/RISRoadClassAudit/Update", "~/API/RISRoadClassAudit/Destroy")]
    public sealed class RISRoadClassAuditModel : ModelBase
    {
		[Key]
		...
		public int RISRoadClassAudit_Key { get; set; }
		...
		[Display(Name = "RIS Road Class Key")]
		[IrisGridColumn(Width = 150)]
