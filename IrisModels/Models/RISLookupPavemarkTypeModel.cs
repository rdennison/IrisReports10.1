...
{
    //[IrisGrid("~/API/RISLookupPavemarkType/Read", "~/API/RISLookupPavemarkType/Create", "~/API/RISLookupPavemarkType/Update", "~/API/RISLookupPavemarkType/Destroy")]
    public sealed class RISLookupPavemarkTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupPavemarkType_Key { get; set; }
