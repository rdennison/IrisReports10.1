...
{
    //[IrisGrid("~/API/RISLookupSignalPreemptionType/Read", "~/API/RISLookupSignalPreemptionType/Create", "~/API/RISLookupSignalPreemptionType/Update", "~/API/RISLookupSignalPreemptionType/Destroy")]
    public sealed class RISLookupSignalPreemptionTypeModel : ModelBase
    {
		[Key]
