...
{
    //[IrisGrid("~/API/RBFType/Read", "~/API/RBFType/Create", "~/API/RBFType/Update", "~/API/RBFType/Destroy")]
    public sealed class RBFTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RBFType_Key { get; set; }
