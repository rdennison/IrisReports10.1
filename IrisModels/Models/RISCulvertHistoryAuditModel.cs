...
{
    //[IrisGrid("~/API/RISCulvertHistoryAudit/Read", "~/API/RISCulvertHistoryAudit/Create", "~/API/RISCulvertHistoryAudit/Update", "~/API/RISCulvertHistoryAudit/Destroy")]
    public sealed class RISCulvertHistoryAuditModel : ModelBase
    {
		[Key]
		...
		public int RISCulvertHistoryAudit_Key { get; set; }
		...
		[Display(Name = "RIS Culvert History Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public Int64 RISCulvertHistory_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[FilterType(Number = true)]
		[Display(Name = "RIS Lookup Culvert History Action Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[FilterType(Number = true)]
		[Display(Name = "RIS Lookup Culvert History Defect Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
