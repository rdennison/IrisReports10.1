...
{
    //[IrisGrid("~/API/RISLookupCulvertInlet/Read", "~/API/RISLookupCulvertInlet/Create", "~/API/RISLookupCulvertInlet/Update", "~/API/RISLookupCulvertInlet/Destroy")]
    public sealed class RISLookupCulvertInletModel : ModelBase
    {
		[Key]
