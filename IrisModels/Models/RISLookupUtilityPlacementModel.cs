...
{
    //[IrisGrid("~/API/RISLookupUtilityPlacement/Read", "~/API/RISLookupUtilityPlacement/Create", "~/API/RISLookupUtilityPlacement/Update", "~/API/RISLookupUtilityPlacement/Destroy")]
    public sealed class RISLookupUtilityPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupUtilityPlacement_Key { get; set; }
