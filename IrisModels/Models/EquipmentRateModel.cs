...
{
    //[IrisGrid("~/API/EquipmentRate/Read", "~/API/EquipmentRate/Create", "~/API/EquipmentRate/Update", "~/API/EquipmentRate/Destroy")]
    public sealed class EquipmentRateModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 EquipmentRate_Key { get; set; }
