...
{
    //[IrisGrid("~/API/PermitStatus/Read", "~/API/PermitStatus/Create", "~/API/PermitStatus/Update", "~/API/PermitStatus/Destroy")]
    public sealed class PermitStatusModel : ModelBase
    {
		[Key]
