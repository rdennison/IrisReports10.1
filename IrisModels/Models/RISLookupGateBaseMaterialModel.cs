...
{
    //[IrisGrid("~/API/RISLookupGateBaseMaterial/Read", "~/API/RISLookupGateBaseMaterial/Create", "~/API/RISLookupGateBaseMaterial/Update", "~/API/RISLookupGateBaseMaterial/Destroy")]
    public sealed class RISLookupGateBaseMaterialModel : ModelBase
    {
		[Key]
