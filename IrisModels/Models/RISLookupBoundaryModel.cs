...
{
    //[IrisGrid("~/API/RISLookupBoundary/Read", "~/API/RISLookupBoundary/Create", "~/API/RISLookupBoundary/Update", "~/API/RISLookupBoundary/Destroy")]
    public sealed class RISLookupBoundaryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupBoundary_Key { get; set; }
