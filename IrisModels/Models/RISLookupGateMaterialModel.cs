...
{
    //[IrisGrid("~/API/RISLookupGateMaterial/Read", "~/API/RISLookupGateMaterial/Create", "~/API/RISLookupGateMaterial/Update", "~/API/RISLookupGateMaterial/Destroy")]
    public sealed class RISLookupGateMaterialModel : ModelBase
    {
		[Key]
