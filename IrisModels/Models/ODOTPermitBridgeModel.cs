...
{
    //[IrisGrid("~/API/ODOTPermitBridge/Read", "~/API/ODOTPermitBridge/Create", "~/API/ODOTPermitBridge/Update", "~/API/ODOTPermitBridge/Destroy")]
    public sealed class ODOTPermitBridgeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 ODOTPermitBridge_Key { get; set; }

		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[ForeignKey(typeof(ODOTPermitModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "ODOT Permit Key")]
		[IrisGridColumn(Width = 150)]
		...
		[Required(ErrorMessage = "Your {0} is required.")]
		[DataType("Byte")]
		[Display(Name = "Drive Down Center")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
