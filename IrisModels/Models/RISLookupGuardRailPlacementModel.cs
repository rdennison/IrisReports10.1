...
{
    //[IrisGrid("~/API/RISLookupGuardRailPlacement/Read", "~/API/RISLookupGuardRailPlacement/Create", "~/API/RISLookupGuardRailPlacement/Update", "~/API/RISLookupGuardRailPlacement/Destroy")]
    public sealed class RISLookupGuardRailPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupGuardRailPlacement_Key { get; set; }
