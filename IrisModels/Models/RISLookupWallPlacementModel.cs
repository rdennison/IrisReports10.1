...
{
    //[IrisGrid("~/API/RISLookupWallPlacement/Read", "~/API/RISLookupWallPlacement/Create", "~/API/RISLookupWallPlacement/Update", "~/API/RISLookupWallPlacement/Destroy")]
    public sealed class RISLookupWallPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupWallPlacement_Key { get; set; }
