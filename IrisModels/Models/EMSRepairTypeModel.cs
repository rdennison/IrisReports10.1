...
{
    //[IrisGrid("~/API/EMSRepairType/Read", "~/API/EMSRepairType/Create", "~/API/EMSRepairType/Update", "~/API/EMSRepairType/Destroy")]
    public sealed class EMSRepairTypeModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 181)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IsExcludeSql]
		[FilterType(Text = true)]
