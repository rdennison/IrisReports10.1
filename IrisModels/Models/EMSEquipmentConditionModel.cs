...
{
    //[IrisGrid("~/API/EMSEquipmentCondition/Read", "~/API/EMSEquipmentCondition/Create", "~/API/EMSEquipmentCondition/Update", "~/API/EMSEquipmentCondition/Destroy")]
    public sealed class EMSEquipmentConditionModel : ModelBase
    {
		[Key]
