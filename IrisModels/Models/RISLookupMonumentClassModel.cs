...
{
    //[IrisGrid("~/API/RISLookupMonumentClass/Read", "~/API/RISLookupMonumentClass/Create", "~/API/RISLookupMonumentClass/Update", "~/API/RISLookupMonumentClass/Destroy")]
    public sealed class RISLookupMonumentClassModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupMonumentClass_Key { get; set; }
