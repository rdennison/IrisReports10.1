...
{
    [Report(Module = "Road Inventory", Display = "Culdesacs & Turnouts", ListValue = "RISCuldesac")]
    [Security(Module = "Road Inventory", Display = "Culdesacs & Turnouts", ListValue = "RISCuldesac")]
    public sealed class RISCuldesacModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISCuldesac_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupCuldesacPlacementModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Culdesac Placement Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public Int64? RISLookupCuldesacPlacement_Key { get; set; }
