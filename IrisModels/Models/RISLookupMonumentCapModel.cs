...
{
    //[IrisGrid("~/API/RISLookupMonumentCap/Read", "~/API/RISLookupMonumentCap/Create", "~/API/RISLookupMonumentCap/Update", "~/API/RISLookupMonumentCap/Destroy")]
    public sealed class RISLookupMonumentCapModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupMonumentCap_Key { get; set; }
