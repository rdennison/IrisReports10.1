...
{
    //[IrisGrid("~/API/RISLookupSignalPowerSource/Read", "~/API/RISLookupSignalPowerSource/Create", "~/API/RISLookupSignalPowerSource/Update", "~/API/RISLookupSignalPowerSource/Destroy")]
    public sealed class RISLookupSignalPowerSourceModel : ModelBase
    {
		[Key]
