...
{
    //[IrisGrid("~/API/EmployeeRateAudit/Read", "~/API/EmployeeRateAudit/Create", "~/API/EmployeeRateAudit/Update", "~/API/EmployeeRateAudit/Destroy")]
    public sealed class EmployeeRateAuditModel : ModelBase
    {
		[Key]
		...
		[Required(ErrorMessage = "Your {0} is required.")]
		[ForeignKey(typeof(EmployeeRateModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "Employee Rate Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
