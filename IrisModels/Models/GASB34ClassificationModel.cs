...
{
    //[IrisGrid("~/API/GASB34Classification/Read", "~/API/GASB34Classification/Create", "~/API/GASB34Classification/Update", "~/API/GASB34Classification/Destroy")]
    public sealed class GASB34ClassificationModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 GASB34Classification_Key { get; set; }
