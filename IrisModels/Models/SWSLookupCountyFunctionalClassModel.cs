...
{
    [Security(Module = "Street Wise", Display = "County Functional Class", ListValue = "SWSLookupCountyFunctionalClass")]
    public sealed class SWSLookupCountyFunctionalClassModel : ModelBase
    {
		[Key]
