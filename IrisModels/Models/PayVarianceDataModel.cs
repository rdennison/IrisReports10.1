...
{
    //[IrisGrid("~/API/PayVarianceData/Read", "~/API/PayVarianceData/Create", "~/API/PayVarianceData/Update", "~/API/PayVarianceData/Destroy")]
    public sealed class PayVarianceDataModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 PayVarianceData_Key { get; set; }
