...
{
    //[IrisGrid("~/API/RISLookupADTCounter/Read", "~/API/RISLookupADTCounter/Create", "~/API/RISLookupADTCounter/Update", "~/API/RISLookupADTCounter/Destroy")]
    public sealed class RISLookupADTCounterModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupADTCounter_Key { get; set; }
