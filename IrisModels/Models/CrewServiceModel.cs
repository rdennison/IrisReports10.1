...
{
    //[IrisGrid("~/API/CrewService/Read", "~/API/CrewService/Create", "~/API/CrewService/Update", "~/API/CrewService/Destroy")]
    public sealed class CrewServiceModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 CrewService_Key { get; set; }
