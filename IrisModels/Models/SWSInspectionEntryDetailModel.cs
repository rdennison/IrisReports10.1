...
{
    //[IrisGrid("~/API/SWSInspectionEntryDetail/Read", "~/API/SWSInspectionEntryDetail/Create", "~/API/SWSInspectionEntryDetail/Update", "~/API/SWSInspectionEntryDetail/Destroy")]
    public sealed class SWSInspectionEntryDetailModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 SWSInspectionEntryDetail_Key { get; set; }

		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[ForeignKey(typeof(SWSInspectionEntryModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "SWS Inspection Entry Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public Int64 SWSInspectionEntry_Key { get; set; }
