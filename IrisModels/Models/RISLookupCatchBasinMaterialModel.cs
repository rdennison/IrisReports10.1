...
{
    //[IrisGrid("~/API/RISLookupCatchBasinMaterial/Read", "~/API/RISLookupCatchBasinMaterial/Create", "~/API/RISLookupCatchBasinMaterial/Update", "~/API/RISLookupCatchBasinMaterial/Destroy")]
    public sealed class RISLookupCatchBasinMaterialModel : ModelBase
    {
		[Key]
