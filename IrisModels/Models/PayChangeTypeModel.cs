...
{
    //[IrisGrid("~/API/PayChangeType/Read", "~/API/PayChangeType/Create", "~/API/PayChangeType/Update", "~/API/PayChangeType/Destroy")]
    public sealed class PayChangeTypeModel : ModelBase
    {
		[Key]
