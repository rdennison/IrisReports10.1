...
{
    [Report(Module = "Road Inventory", Display = "Boundaries", ListValue = "RISBoundary")]
    [Security(Module = "Road Inventory", Display = "Boundaries", ListValue = "RISBoundary")]
    public sealed class RISBoundaryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISBoundary_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupBoundaryModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Boundary Key")]
		[IrisGridColumn(Width = 150)]
