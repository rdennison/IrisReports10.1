...
{
    [Report(Module = "Accounts Payable", Display = "Vendor", ListValue = "Vendor")]
    [Security(Module = "Accounts Payable", Display = "Vendor", ListValue = "Vendor")]
    [EditorType(InCell = true)]
    public sealed class VendorModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 20)]
		[FilterType(Text = true)]
		[Display(Name = "Alternate Vendor No")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public string AlternateVendorNo { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 94)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IsExcludeSql]
		[FilterType(Text = true)]
		...
		[DataType("Byte")]
		[Display(Name = "Send 1099")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public byte? Send1099 { get; set; }

		[DbProperties(DatabaseType = SqlDbType.Char, Size = 10)]
		[FilterType(Text = true)]
		[Display(Name = "Box Number 1099")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
