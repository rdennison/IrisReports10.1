...
{
    //[IrisGrid("~/API/RISLookupAdjDevelopPlacement/Read", "~/API/RISLookupAdjDevelopPlacement/Create", "~/API/RISLookupAdjDevelopPlacement/Update", "~/API/RISLookupAdjDevelopPlacement/Destroy")]
    public sealed class RISLookupAdjDevelopPlacementModel : ModelBase
    {
		[Key]
