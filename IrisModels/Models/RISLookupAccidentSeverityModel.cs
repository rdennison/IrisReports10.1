...
{
    //[IrisGrid("~/API/RISLookupAccidentSeverity/Read", "~/API/RISLookupAccidentSeverity/Create", "~/API/RISLookupAccidentSeverity/Update", "~/API/RISLookupAccidentSeverity/Destroy")]
    public sealed class RISLookupAccidentSeverityModel : ModelBase
    {
		[Key]
