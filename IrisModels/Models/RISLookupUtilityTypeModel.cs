...
{
    //[IrisGrid("~/API/RISLookupUtilityType/Read", "~/API/RISLookupUtilityType/Create", "~/API/RISLookupUtilityType/Update", "~/API/RISLookupUtilityType/Destroy")]
    public sealed class RISLookupUtilityTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupUtilityType_Key { get; set; }
