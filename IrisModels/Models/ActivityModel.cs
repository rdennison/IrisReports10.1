...
{
    [Report(Module = "Cost Accounting", Display = "Activity", ListValue = "Activity")]
    [Security(Module = "Cost Accounting", Display = "Activity", ListValue = "Activity")]
    [LookupDisplay(Name = "CAS - Activity")]
    public sealed class ActivityModel : ModelBase
    {
		[Key]
		...
		[Display(Name = "Perform Standard")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? PerformStandard { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(WorkCompModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "Work Comp Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
