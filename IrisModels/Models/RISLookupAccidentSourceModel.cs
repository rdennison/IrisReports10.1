...
{
    //[IrisGrid("~/API/RISLookupAccidentSource/Read", "~/API/RISLookupAccidentSource/Create", "~/API/RISLookupAccidentSource/Update", "~/API/RISLookupAccidentSource/Destroy")]
    public sealed class RISLookupAccidentSourceModel : ModelBase
    {
		[Key]
