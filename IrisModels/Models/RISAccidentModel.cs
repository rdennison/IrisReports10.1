...
{
    [Report(Module = "Road Inventory", Display = "Accidents", ListValue = "RISAccident")]
    [Security(Module = "Road Inventory", Display = "Accidents", ListValue = "RISAccident")]
    public sealed class RISAccidentModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISAccident_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[FilterType(Number = true)]
		[Display(Name = "RIS Lookup Accident Severity Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public Int64? RISLookupAccidentSeverity_Key { get; set; }

		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[FilterType(Number = true)]
		[Display(Name = "RIS Lookup Accident Source Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public Int64? RISLookupAccidentSource_Key { get; set; }

		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 8)]
		[FilterType(Text = true)]
		[Display(Name = "Weather Code")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
