...
{
    [Report(Module = "Road Inventory", Display = "Curbs", ListValue = "RISCurb")]
    [Security(Module = "Road Inventory", Display = "Curbs", ListValue = "RISCurb")]
    [LookupDisplay(Name = "RIS - Curbs")]
    public sealed class RISCurbModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISCurb_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(RISLookupCurbPlacementModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Curb Placement Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public Int64? RISLookupCurbPlacement_Key { get; set; }
		...
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Curb Height")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? CurbHeight { get; set; }
