...
{
    [Report(Module = "Equipment Management", Display = "Maintenance Entry", ListValue = "EMSMaintEntry")]
    [Security(Module = "Equipment Management", Display = "Maintenance Entry", ListValue = "EMSMaintEntry")]
    [LookupDisplay(Name = "EMS - Maintenance Entry")]
    public sealed class EMSMaintEntryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 EMSMaintEntry_Key { get; set; }
