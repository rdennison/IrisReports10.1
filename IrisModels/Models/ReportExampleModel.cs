...
{
    //[IrisGrid("~/API/ReportExample/Read", "~/API/ReportExample/Create", "~/API/ReportExample/Update", "~/API/ReportExample/Destroy")]
    public sealed class ReportExampleModel : ModelBase
    {
		[Key]
		...
		public int ReportExample_Key { get; set; }
