...
{
    //[IrisGrid("~/API/RISLookupPavemarkPlacement/Read", "~/API/RISLookupPavemarkPlacement/Create", "~/API/RISLookupPavemarkPlacement/Update", "~/API/RISLookupPavemarkPlacement/Destroy")]
    public sealed class RISLookupPavemarkPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupPavemarkPlacement_Key { get; set; }
