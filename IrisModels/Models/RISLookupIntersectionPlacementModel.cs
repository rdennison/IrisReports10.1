...
{
    //[IrisGrid("~/API/RISLookupIntersectionPlacement/Read", "~/API/RISLookupIntersectionPlacement/Create", "~/API/RISLookupIntersectionPlacement/Update", "~/API/RISLookupIntersectionPlacement/Destroy")]
    public sealed class RISLookupIntersectionPlacementModel : ModelBase
    {
		[Key]
