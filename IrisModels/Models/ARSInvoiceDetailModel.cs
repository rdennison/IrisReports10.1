...
{
    //[IrisGrid("~/API/ARSInvoiceDetail/Read", "~/API/ARSInvoiceDetail/Create", "~/API/ARSInvoiceDetail/Update", "~/API/ARSInvoiceDetail/Destroy")]
    public sealed class ARSInvoiceDetailModel : ModelBase
    {
		[Key]
