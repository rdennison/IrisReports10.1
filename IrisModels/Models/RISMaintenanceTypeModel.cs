...
{
    //[IrisGrid("~/API/RISMaintenanceType/Read", "~/API/RISMaintenanceType/Create", "~/API/RISMaintenanceType/Update", "~/API/RISMaintenanceType/Destroy")]
    public sealed class RISMaintenanceTypeModel : ModelBase
    {
		[Key]
