...
{
    //[IrisGrid("~/API/RISLookupCurbPlacement/Read", "~/API/RISLookupCurbPlacement/Create", "~/API/RISLookupCurbPlacement/Update", "~/API/RISLookupCurbPlacement/Destroy")]
    public sealed class RISLookupCurbPlacementModel : ModelBase
    {
		[Key]
