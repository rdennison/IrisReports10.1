...
{
    //[IrisGrid("~/API/RISLookupCatchBasinGrate/Read", "~/API/RISLookupCatchBasinGrate/Create", "~/API/RISLookupCatchBasinGrate/Update", "~/API/RISLookupCatchBasinGrate/Destroy")]
    public sealed class RISLookupCatchBasinGrateModel : ModelBase
    {
		[Key]
