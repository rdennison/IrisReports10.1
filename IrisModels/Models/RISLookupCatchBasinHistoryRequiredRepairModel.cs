...
{
    //[IrisGrid("~/API/RISLookupCatchBasinHistoryRequiredRepair/Read", "~/API/RISLookupCatchBasinHistoryRequiredRepair/Create", "~/API/RISLookupCatchBasinHistoryRequiredRepair/Update", "~/API/RISLookupCatchBasinHistoryRequiredRepair/Destroy")]
    public sealed class RISLookupCatchBasinHistoryRequiredRepairModel : ModelBase
    {
		[Key]
