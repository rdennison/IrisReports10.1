...
{
    //[IrisGrid("~/API/RISLookupCulvertCondition/Read", "~/API/RISLookupCulvertCondition/Create", "~/API/RISLookupCulvertCondition/Update", "~/API/RISLookupCulvertCondition/Destroy")]
    public sealed class RISLookupCulvertConditionModel : ModelBase
    {
		[Key]
