...
{
    //[IrisGrid("~/API/RISBridgeHistory/Read", "~/API/RISBridgeHistory/Create", "~/API/RISBridgeHistory/Update", "~/API/RISBridgeHistory/Destroy")]
    public sealed class RISBridgeHistoryModel : ModelBase
    {
		[Key]
