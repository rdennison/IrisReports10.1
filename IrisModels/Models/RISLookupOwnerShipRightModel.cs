...
{
    //[IrisGrid("~/API/RISLookupOwnerShipRight/Read", "~/API/RISLookupOwnerShipRight/Create", "~/API/RISLookupOwnerShipRight/Update", "~/API/RISLookupOwnerShipRight/Destroy")]
    public sealed class RISLookupOwnerShipRightModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupOwnerShipRight_Key { get; set; }
