...
{
    //[IrisGrid("~/API/RISLookupBridgeConstraint/Read", "~/API/RISLookupBridgeConstraint/Create", "~/API/RISLookupBridgeConstraint/Update", "~/API/RISLookupBridgeConstraint/Destroy")]
    public sealed class RISLookupBridgeConstraintModel : ModelBase
    {
		[Key]
