...
{
    //[IrisGrid("~/API/RISLookupCity/Read", "~/API/RISLookupCity/Create", "~/API/RISLookupCity/Update", "~/API/RISLookupCity/Destroy")]
    public sealed class RISLookupCityModel : ModelBase
    {
		[Key]
