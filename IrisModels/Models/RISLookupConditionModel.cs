...
{
    //[IrisGrid("~/API/RISLookupCondition/Read", "~/API/RISLookupCondition/Create", "~/API/RISLookupCondition/Update", "~/API/RISLookupCondition/Destroy")]
    public sealed class RISLookupConditionModel : ModelBase
    {
		[Key]
