...
{
    //[IrisGrid("~/API/RISLookupGateHistoryAction/Read", "~/API/RISLookupGateHistoryAction/Create", "~/API/RISLookupGateHistoryAction/Update", "~/API/RISLookupGateHistoryAction/Destroy")]
    public sealed class RISLookupGateHistoryActionModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupGateHistoryAction_Key { get; set; }
