...
{
    [Report(Module = "Accounts Payable", Display = "Contract", ListValue = "Contract")]
    [Security(Module = "Accounts Payable", Display = "Contract", ListValue = "Contract")]
    public sealed class ContractModel : ModelBase
    {
		[Key]
