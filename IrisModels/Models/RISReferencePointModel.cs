...
{
    [Report(Module = "Road Inventory", Display = "Reference Points", ListValue = "RISReferencePoint")]
    [Security(Module = "Road Inventory", Display = "Reference Points", ListValue = "RISReferencePoint")]
    public sealed class RISReferencePointModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISReferencePoint_Key { get; set; }
