...
{
    //[IrisGrid("~/API/EMSEquipmentStatus/Read", "~/API/EMSEquipmentStatus/Create", "~/API/EMSEquipmentStatus/Update", "~/API/EMSEquipmentStatus/Destroy")]
    public sealed class EMSEquipmentStatusModel : ModelBase
    {
		[Key]
