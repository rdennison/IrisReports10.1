...
{
    //[IrisGrid("~/API/RISLookupCulvertQuantity/Read", "~/API/RISLookupCulvertQuantity/Create", "~/API/RISLookupCulvertQuantity/Update", "~/API/RISLookupCulvertQuantity/Destroy")]
    public sealed class RISLookupCulvertQuantityModel : ModelBase
    {
		[Key]
