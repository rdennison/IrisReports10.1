...
{
    //[IrisGrid("~/API/RISLookupCatchBasinDrain/Read", "~/API/RISLookupCatchBasinDrain/Create", "~/API/RISLookupCatchBasinDrain/Update", "~/API/RISLookupCatchBasinDrain/Destroy")]
    public sealed class RISLookupCatchBasinDrainModel : ModelBase
    {
		[Key]
