...
{
    //[IrisGrid("~/API/RISLookupDirection/Read", "~/API/RISLookupDirection/Create", "~/API/RISLookupDirection/Update", "~/API/RISLookupDirection/Destroy")]
    public sealed class RISLookupDirectionModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupDirection_Key { get; set; }
