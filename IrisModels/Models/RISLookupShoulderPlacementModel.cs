...
{
    //[IrisGrid("~/API/RISLookupShoulderPlacement/Read", "~/API/RISLookupShoulderPlacement/Create", "~/API/RISLookupShoulderPlacement/Update", "~/API/RISLookupShoulderPlacement/Destroy")]
    public sealed class RISLookupShoulderPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupShoulderPlacement_Key { get; set; }
