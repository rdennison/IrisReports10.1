...
{
    //[IrisGrid("~/API/RISLookupLeveeHistoryAction/Read", "~/API/RISLookupLeveeHistoryAction/Create", "~/API/RISLookupLeveeHistoryAction/Update", "~/API/RISLookupLeveeHistoryAction/Destroy")]
    public sealed class RISLookupLeveeHistoryActionModel : ModelBase
    {
		[Key]
