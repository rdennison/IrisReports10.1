...
{
    //[IrisGrid("~/API/PayType/Read", "~/API/PayType/Create", "~/API/PayType/Update", "~/API/PayType/Destroy")]
    public sealed class PayTypeModel : ModelBase
    {
		[Key]
