...
{
    //[IrisGrid("~/API/RISLookupGuardRailBlockSize/Read", "~/API/RISLookupGuardRailBlockSize/Create", "~/API/RISLookupGuardRailBlockSize/Update", "~/API/RISLookupGuardRailBlockSize/Destroy")]
    public sealed class RISLookupGuardRailBlockSizeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupGuardRailBlockSize_Key { get; set; }
