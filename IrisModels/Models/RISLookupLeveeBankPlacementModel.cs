...
{
    //[IrisGrid("~/API/RISLookupLeveeBankPlacement/Read", "~/API/RISLookupLeveeBankPlacement/Create", "~/API/RISLookupLeveeBankPlacement/Update", "~/API/RISLookupLeveeBankPlacement/Destroy")]
    public sealed class RISLookupLeveeBankPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupLeveeBankPlacement_Key { get; set; }
