...
{
    //[IrisGrid("~/API/SERLookupUtilityPermitType/Read", "~/API/SERLookupUtilityPermitType/Create", "~/API/SERLookupUtilityPermitType/Update", "~/API/SERLookupUtilityPermitType/Destroy")]
    public sealed class SERLookupUtilityPermitTypeModel : ModelBase
    {
		[Key]
