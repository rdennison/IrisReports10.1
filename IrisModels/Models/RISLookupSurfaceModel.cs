...
{
    //[IrisGrid("~/API/RISLookupSurface/Read", "~/API/RISLookupSurface/Create", "~/API/RISLookupSurface/Update", "~/API/RISLookupSurface/Destroy")]
    public sealed class RISLookupSurfaceModel : ModelBase
    {
		[Key]
