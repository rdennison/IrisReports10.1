...
{
    [Report(Module = "Street Wise", Display = "Maintenance History", ListValue = "SWSMaintenanceHistory")]
    [Security(Module = "Street Wise", Display = "Maintenance History SWS", ListValue = "SWSMaintenanceHistory")]
    public sealed class SWSMaintenanceHistoryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 SWSMaintenanceHistory_Key { get; set; }
