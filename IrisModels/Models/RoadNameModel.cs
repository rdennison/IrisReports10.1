...
{
    //[IrisGrid("~/API/RoadName/Read", "~/API/RoadName/Create", "~/API/RoadName/Update", "~/API/RoadName/Destroy")]
    public sealed class RoadNameModel : ModelBase
    {
		[Key]
		...
		[ForeignKey(typeof(RISLookupRoadNameRoadTypeModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Road Name Road Type Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public string RISLookupRoadNameRoadType_Key { get; set; }

		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 2)]
		[ForeignKey(typeof(RISLookupRoadNameDirectionModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "RIS Lookup Road Name Direction Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 38)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IsExcludeSql]
		[FilterType(Text = true)]
		[Display(Name = "Road Name Type Direction")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public string RoadNameTypeDirection { get; set; }

		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 66)]
		[IsExcludeSql]
		[FilterType(Text = true)]
		[Display(Name = "Full Road Name")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
