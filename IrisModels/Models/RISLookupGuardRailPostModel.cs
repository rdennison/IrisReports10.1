...
{
    //[IrisGrid("~/API/RISLookupGuardRailPost/Read", "~/API/RISLookupGuardRailPost/Create", "~/API/RISLookupGuardRailPost/Update", "~/API/RISLookupGuardRailPost/Destroy")]
    public sealed class RISLookupGuardRailPostModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupGuardRailPost_Key { get; set; }
