...
{
    [Report(Module = "Equipment Management", Display = "Work Order", ListValue = "EMSWorkOrder")]
    [Security(Module = "Equipment Management", Display = "Work Order", ListValue = "EMSWorkOrder")]
    [LookupDisplay(Name = "EMS - Work Order")]
    public sealed class EMSWorkOrderModel : ModelBase
    {
		[Key]
		...
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[ForeignKey(typeof(EMSWorkOrderStatusModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "EMS Work Order Status Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
