...
{
    //[IrisGrid("~/API/PermitFeeType/Read", "~/API/PermitFeeType/Create", "~/API/PermitFeeType/Update", "~/API/PermitFeeType/Destroy")]
    public sealed class PermitFeeTypeModel : ModelBase
    {
		[Key]
