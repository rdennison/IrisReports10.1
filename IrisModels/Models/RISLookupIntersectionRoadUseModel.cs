...
{
    //[IrisGrid("~/API/RISLookupIntersectionRoadUse/Read", "~/API/RISLookupIntersectionRoadUse/Create", "~/API/RISLookupIntersectionRoadUse/Update", "~/API/RISLookupIntersectionRoadUse/Destroy")]
    public sealed class RISLookupIntersectionRoadUseModel : ModelBase
    {
		[Key]
