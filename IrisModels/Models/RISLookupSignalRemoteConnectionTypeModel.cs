...
{
    //[IrisGrid("~/API/RISLookupSignalRemoteConnectionType/Read", "~/API/RISLookupSignalRemoteConnectionType/Create", "~/API/RISLookupSignalRemoteConnectionType/Update", "~/API/RISLookupSignalRemoteConnectionType/Destroy")]
    public sealed class RISLookupSignalRemoteConnectionTypeModel : ModelBase
    {
		[Key]
