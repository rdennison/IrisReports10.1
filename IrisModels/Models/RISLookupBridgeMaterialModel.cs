...
{
    //[IrisGrid("~/API/RISLookupBridgeMaterial/Read", "~/API/RISLookupBridgeMaterial/Create", "~/API/RISLookupBridgeMaterial/Update", "~/API/RISLookupBridgeMaterial/Destroy")]
    public sealed class RISLookupBridgeMaterialModel : ModelBase
    {
		[Key]
