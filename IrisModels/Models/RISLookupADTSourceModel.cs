...
{
    //[IrisGrid("~/API/RISLookupADTSource/Read", "~/API/RISLookupADTSource/Create", "~/API/RISLookupADTSource/Update", "~/API/RISLookupADTSource/Destroy")]
    public sealed class RISLookupADTSourceModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupADTSource_Key { get; set; }
