...
{
    //[IrisGrid("~/API/SERLookupUtilityPermitInstalledLocation/Read", "~/API/SERLookupUtilityPermitInstalledLocation/Create", "~/API/SERLookupUtilityPermitInstalledLocation/Update", "~/API/SERLookupUtilityPermitInstalledLocation/Destroy")]
    public sealed class SERLookupUtilityPermitInstalledLocationModel : ModelBase
    {
		[Key]
