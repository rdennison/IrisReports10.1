...
{
    [Report(Module = "Street Wise", Display = "Management Section", ListValue = "SWSManagementSection")]
    [Security(Module = "Street Wise", Display = "Management Section", ListValue = "SWSManagementSection")]
    public sealed class SWSManagementSectionModel : ModelBase
    {
		[Key]
