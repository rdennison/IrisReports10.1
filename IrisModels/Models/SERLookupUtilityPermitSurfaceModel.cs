...
{
    //[IrisGrid("~/API/SERLookupUtilityPermitSurface/Read", "~/API/SERLookupUtilityPermitSurface/Create", "~/API/SERLookupUtilityPermitSurface/Update", "~/API/SERLookupUtilityPermitSurface/Destroy")]
    public sealed class SERLookupUtilityPermitSurfaceModel : ModelBase
    {
		[Key]
