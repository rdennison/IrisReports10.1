...
{
    //[IrisGrid("~/API/RISLookupCulvertOutlet/Read", "~/API/RISLookupCulvertOutlet/Create", "~/API/RISLookupCulvertOutlet/Update", "~/API/RISLookupCulvertOutlet/Destroy")]
    public sealed class RISLookupCulvertOutletModel : ModelBase
    {
		[Key]
