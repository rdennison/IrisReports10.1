...
{
    [Security(Module = "Equipment Management", Display = "Related Department History", ListValue = "EMSDepartmentHistory")]
    [LookupDisplay(Name = "EMS - Related Department History")]
    public sealed class EMSDepartmentHistoryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 EMSDepartmentHistory_Key { get; set; }
		...
		[Display(Name = "Lifetime Total Hours")]
		[IrisGridColumn(Width = 150)]
		...
		[DataType("Integer")]
		[FilterType(Number = true)]
		[Display(Name = "Lifetime Total Miles")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		...
		[DataType("Integer")]
		[FilterType(Number = true)]
		[Display(Name = "Ending Lifetime Total Hours")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		...
		[DataType("Integer")]
		[FilterType(Number = true)]
		[Display(Name = "Ending Lifetime Total Miles")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
