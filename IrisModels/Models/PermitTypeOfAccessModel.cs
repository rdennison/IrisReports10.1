...
{
    //[IrisGrid("~/API/PermitTypeOfAccess/Read", "~/API/PermitTypeOfAccess/Create", "~/API/PermitTypeOfAccess/Update", "~/API/PermitTypeOfAccess/Destroy")]
    public sealed class PermitTypeOfAccessModel : ModelBase
    {
		[Key]
