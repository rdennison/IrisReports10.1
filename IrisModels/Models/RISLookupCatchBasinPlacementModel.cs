...
{
    //[IrisGrid("~/API/RISLookupCatchBasinPlacement/Read", "~/API/RISLookupCatchBasinPlacement/Create", "~/API/RISLookupCatchBasinPlacement/Update", "~/API/RISLookupCatchBasinPlacement/Destroy")]
    public sealed class RISLookupCatchBasinPlacementModel : ModelBase
    {
		[Key]
