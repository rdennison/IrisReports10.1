...
{
    //[IrisGrid("~/API/RISLookupGate/Read", "~/API/RISLookupGate/Create", "~/API/RISLookupGate/Update", "~/API/RISLookupGate/Destroy")]
    public sealed class RISLookupGateModel : ModelBase
    {
		[Key]
