...
{
    //[IrisGrid("~/API/RISLookupSignalDetectionType/Read", "~/API/RISLookupSignalDetectionType/Create", "~/API/RISLookupSignalDetectionType/Update", "~/API/RISLookupSignalDetectionType/Destroy")]
    public sealed class RISLookupSignalDetectionTypeModel : ModelBase
    {
		[Key]
