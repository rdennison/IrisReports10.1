...
{
    //[IrisGrid("~/API/ProjectResourceItemBillRate/Read", "~/API/ProjectResourceItemBillRate/Create", "~/API/ProjectResourceItemBillRate/Update", "~/API/ProjectResourceItemBillRate/Destroy")]
    public sealed class ProjectResourceItemBillRateModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 ProjectResourceItemBillRate_Key { get; set; }
