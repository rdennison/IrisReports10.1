...
{
    //[IrisGrid("~/API/RISLookupBarrier/Read", "~/API/RISLookupBarrier/Create", "~/API/RISLookupBarrier/Update", "~/API/RISLookupBarrier/Destroy")]
    public sealed class RISLookupBarrierModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupBarrier_Key { get; set; }
