...
{
    //[IrisGrid("~/API/SERLookupUtilityPermitPlacement/Read", "~/API/SERLookupUtilityPermitPlacement/Create", "~/API/SERLookupUtilityPermitPlacement/Update", "~/API/SERLookupUtilityPermitPlacement/Destroy")]
    public sealed class SERLookupUtilityPermitPlacementModel : ModelBase
    {
		[Key]
