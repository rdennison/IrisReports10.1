...
{
    //[IrisGrid("~/API/RISLookupCulvertCoating/Read", "~/API/RISLookupCulvertCoating/Create", "~/API/RISLookupCulvertCoating/Update", "~/API/RISLookupCulvertCoating/Destroy")]
    public sealed class RISLookupCulvertCoatingModel : ModelBase
    {
		[Key]
