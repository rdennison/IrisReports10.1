...
{
    //[IrisGrid("~/API/RISLookupIlluminationMast/Read", "~/API/RISLookupIlluminationMast/Create", "~/API/RISLookupIlluminationMast/Update", "~/API/RISLookupIlluminationMast/Destroy")]
    public sealed class RISLookupIlluminationMastModel : ModelBase
    {
		[Key]
