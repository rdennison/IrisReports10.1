...
{
    //[IrisGrid("~/API/RISLookupGateManufacture/Read", "~/API/RISLookupGateManufacture/Create", "~/API/RISLookupGateManufacture/Update", "~/API/RISLookupGateManufacture/Destroy")]
    public sealed class RISLookupGateManufactureModel : ModelBase
    {
		[Key]
