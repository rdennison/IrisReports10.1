...
{
    //[IrisGrid("~/API/RISLookupManholePurpose/Read", "~/API/RISLookupManholePurpose/Create", "~/API/RISLookupManholePurpose/Update", "~/API/RISLookupManholePurpose/Destroy")]
    public sealed class RISLookupManholePurposeModel : ModelBase
    {
		[Key]
