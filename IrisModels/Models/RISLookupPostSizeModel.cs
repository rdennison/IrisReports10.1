...
{
    //[IrisGrid("~/API/RISLookupPostSize/Read", "~/API/RISLookupPostSize/Create", "~/API/RISLookupPostSize/Update", "~/API/RISLookupPostSize/Destroy")]
    public sealed class RISLookupPostSizeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupPostSize_Key { get; set; }
