...
{
    //[IrisGrid("~/API/RISLocationReferenceData/Read", "~/API/RISLocationReferenceData/Create", "~/API/RISLocationReferenceData/Update", "~/API/RISLocationReferenceData/Destroy")]
    public sealed class RISLocationReferenceDataModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLocationReferenceData_Key { get; set; }
