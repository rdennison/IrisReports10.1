...
{
    //[IrisGrid("~/API/DocumentType/Read", "~/API/DocumentType/Create", "~/API/DocumentType/Update", "~/API/DocumentType/Destroy")]
    public sealed class DocumentTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 DocumentType_Key { get; set; }
