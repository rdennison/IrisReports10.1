...
{
    //[IrisGrid("~/API/RISLookupOwnerShipLeft/Read", "~/API/RISLookupOwnerShipLeft/Create", "~/API/RISLookupOwnerShipLeft/Update", "~/API/RISLookupOwnerShipLeft/Destroy")]
    public sealed class RISLookupOwnerShipLeftModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupOwnerShipLeft_Key { get; set; }
