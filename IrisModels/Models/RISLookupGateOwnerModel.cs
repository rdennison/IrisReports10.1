...
{
    //[IrisGrid("~/API/RISLookupGateOwner/Read", "~/API/RISLookupGateOwner/Create", "~/API/RISLookupGateOwner/Update", "~/API/RISLookupGateOwner/Destroy")]
    public sealed class RISLookupGateOwnerModel : ModelBase
    {
		[Key]
