...
{
    //[IrisGrid("~/API/RISLookupLaneDirection/Read", "~/API/RISLookupLaneDirection/Create", "~/API/RISLookupLaneDirection/Update", "~/API/RISLookupLaneDirection/Destroy")]
    public sealed class RISLookupLaneDirectionModel : ModelBase
    {
		[Key]
