...
{
    //[IrisGrid("~/API/RISLookupSignSurface/Read", "~/API/RISLookupSignSurface/Create", "~/API/RISLookupSignSurface/Update", "~/API/RISLookupSignSurface/Destroy")]
    public sealed class RISLookupSignSurfaceModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupSignSurface_Key { get; set; }
