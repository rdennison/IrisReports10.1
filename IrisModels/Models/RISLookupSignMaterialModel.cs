...
{
    //[IrisGrid("~/API/RISLookupSignMaterial/Read", "~/API/RISLookupSignMaterial/Create", "~/API/RISLookupSignMaterial/Update", "~/API/RISLookupSignMaterial/Destroy")]
    public sealed class RISLookupSignMaterialModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupSignMaterial_Key { get; set; }
