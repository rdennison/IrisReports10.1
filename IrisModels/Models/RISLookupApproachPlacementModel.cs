...
{
    //[IrisGrid("~/API/RISLookupApproachPlacement/Read", "~/API/RISLookupApproachPlacement/Create", "~/API/RISLookupApproachPlacement/Update", "~/API/RISLookupApproachPlacement/Destroy")]
    public sealed class RISLookupApproachPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupApproachPlacement_Key { get; set; }
