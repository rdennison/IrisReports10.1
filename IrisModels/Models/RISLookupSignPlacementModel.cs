...
{
    //[IrisGrid("~/API/RISLookupSignPlacement/Read", "~/API/RISLookupSignPlacement/Create", "~/API/RISLookupSignPlacement/Update", "~/API/RISLookupSignPlacement/Destroy")]
    public sealed class RISLookupSignPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupSignPlacement_Key { get; set; }
