...
{
    [Report(Module = "Equipment Management", Display = "Reading History", ListValue = "EMSReadingHistory")]
    [Security(Module = "Equipment Management", Display = "Reading History", ListValue = "EMSReadingHistory")]
    public sealed class EMSReadingHistoryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 EMSReadingHistory_Key { get; set; }
