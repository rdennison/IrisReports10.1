...
{
    [Report(Module = "Road Inventory", Display = "MUTCD", ListValue = "RISMUTCD")]
    [Security(Module = "Road Inventory", Display = "MUTCD", ListValue = "RISMUTCD")]
    public sealed class RISMUTCDModel : ModelBase
    {
		[Key]
		...
		//public varbinary? SignImage { get; set; }
