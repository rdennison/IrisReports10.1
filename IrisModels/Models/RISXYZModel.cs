...
{
    //[IrisGrid("~/API/RISXYZ/Read", "~/API/RISXYZ/Create", "~/API/RISXYZ/Update", "~/API/RISXYZ/Destroy")]
    public sealed class RISXYZModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISXYZ_Key { get; set; }
		...
		[DataType("Decimal")]
		[FilterType(Number = true)]
		[Display(Name = "Accuracy Quantity")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public decimal? AccuracyQuantity { get; set; }
