...
{
    //[IrisGrid("~/API/ReportBatchReport/Read", "~/API/ReportBatchReport/Create", "~/API/ReportBatchReport/Update", "~/API/ReportBatchReport/Destroy")]
    public sealed class ReportBatchReportModel : ModelBase
    {
		[Key]
		...
		//public varbinary? CRWMgr { get; set; }
