...
{
    [Report(Module = "Road Inventory", Display = "Maintenance Routes", ListValue = "RISMaintenanceRoute")]
    [Security(Module = "Road Inventory", Display = "Maintenance Routes", ListValue = "RISMaintenanceRoute")]
    public sealed class RISMaintenanceRouteModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISMaintenanceRoute_Key { get; set; }
