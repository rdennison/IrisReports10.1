...
{
    //[IrisGrid("~/API/APSBudgetDetail/Read", "~/API/APSBudgetDetail/Create", "~/API/APSBudgetDetail/Update", "~/API/APSBudgetDetail/Destroy")]
    public sealed class APSBudgetDetailModel : ModelBase
    {
		[Key]
