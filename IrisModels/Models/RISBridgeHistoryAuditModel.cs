...
{
    //[IrisGrid("~/API/RISBridgeHistoryAudit/Read", "~/API/RISBridgeHistoryAudit/Create", "~/API/RISBridgeHistoryAudit/Update", "~/API/RISBridgeHistoryAudit/Destroy")]
    public sealed class RISBridgeHistoryAuditModel : ModelBase
    {
		[Key]
		...
		public int RISBridgeHistoryAudit_Key { get; set; }
		...
		[Display(Name = "RIS Bridge History Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = true, AllowCount = true, AllowMax = true, AllowMin = true, AllowSum = true)]
		public Int64 RISBridgeHistory_Key { get; set; }
		...
		[DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)]
		[FilterType(Date = true)]
		[Display(Name = "Bridge Date")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
		public DateTime? BridgeDate { get; set; }
