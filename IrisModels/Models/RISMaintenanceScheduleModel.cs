...
{
    [LookupDisplay(Name = "RIS - Maintenance Schedule Setup")]
    public sealed class RISMaintenanceScheduleModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISMaintenanceSchedule_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 21)]
		[IsExcludeSql]
		[FilterType(Text = true)]
		[Display(Name = "Compound Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
