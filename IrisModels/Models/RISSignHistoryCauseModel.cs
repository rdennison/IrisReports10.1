...
{
    //[IrisGrid("~/API/RISSignHistoryCause/Read", "~/API/RISSignHistoryCause/Create", "~/API/RISSignHistoryCause/Update", "~/API/RISSignHistoryCause/Destroy")]
    public sealed class RISSignHistoryCauseModel : ModelBase
    {
		[Key]
