...
{
    //[IrisGrid("~/API/RISLookupGateWing/Read", "~/API/RISLookupGateWing/Create", "~/API/RISLookupGateWing/Update", "~/API/RISLookupGateWing/Destroy")]
    public sealed class RISLookupGateWingModel : ModelBase
    {
		[Key]
