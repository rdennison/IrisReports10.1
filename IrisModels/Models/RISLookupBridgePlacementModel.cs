...
{
    //[IrisGrid("~/API/RISLookupBridgePlacement/Read", "~/API/RISLookupBridgePlacement/Create", "~/API/RISLookupBridgePlacement/Update", "~/API/RISLookupBridgePlacement/Destroy")]
    public sealed class RISLookupBridgePlacementModel : ModelBase
    {
		[Key]
