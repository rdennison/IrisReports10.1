...
{
    //[IrisGrid("~/API/RISLookupADTPlacement/Read", "~/API/RISLookupADTPlacement/Create", "~/API/RISLookupADTPlacement/Update", "~/API/RISLookupADTPlacement/Destroy")]
    public sealed class RISLookupADTPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupADTPlacement_Key { get; set; }
