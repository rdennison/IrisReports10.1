...
{
    //[IrisGrid("~/API/RISLookupMedian/Read", "~/API/RISLookupMedian/Create", "~/API/RISLookupMedian/Update", "~/API/RISLookupMedian/Destroy")]
    public sealed class RISLookupMedianModel : ModelBase
    {
		[Key]
