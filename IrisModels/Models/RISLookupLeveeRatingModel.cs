...
{
    //[IrisGrid("~/API/RISLookupLeveeRating/Read", "~/API/RISLookupLeveeRating/Create", "~/API/RISLookupLeveeRating/Update", "~/API/RISLookupLeveeRating/Destroy")]
    public sealed class RISLookupLeveeRatingModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupLeveeRating_Key { get; set; }
