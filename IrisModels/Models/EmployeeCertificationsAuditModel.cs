...
{
    //[IrisGrid("~/API/EmployeeCertificationsAudit/Read", "~/API/EmployeeCertificationsAudit/Create", "~/API/EmployeeCertificationsAudit/Update", "~/API/EmployeeCertificationsAudit/Destroy")]
    public sealed class EmployeeCertificationsAuditModel : ModelBase
    {
		[Key]
		...
		[Required(ErrorMessage = "Your {0} is required.")]
		[ForeignKey(typeof(EmployeeCertificationsModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "Employee Certifications Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
