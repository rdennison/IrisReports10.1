...
{
    //[IrisGrid("~/API/RISLookupWallCondition/Read", "~/API/RISLookupWallCondition/Create", "~/API/RISLookupWallCondition/Update", "~/API/RISLookupWallCondition/Destroy")]
    public sealed class RISLookupWallConditionModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupWallCondition_Key { get; set; }
