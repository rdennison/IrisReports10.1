...
{
    //[IrisGrid("~/API/RISLookupIlluminationLightSource/Read", "~/API/RISLookupIlluminationLightSource/Create", "~/API/RISLookupIlluminationLightSource/Update", "~/API/RISLookupIlluminationLightSource/Destroy")]
    public sealed class RISLookupIlluminationLightSourceModel : ModelBase
    {
		[Key]
