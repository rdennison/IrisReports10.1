...
{
    //[IrisGrid("~/API/RISLookupWallType/Read", "~/API/RISLookupWallType/Create", "~/API/RISLookupWallType/Update", "~/API/RISLookupWallType/Destroy")]
    public sealed class RISLookupWallTypeModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupWallType_Key { get; set; }
