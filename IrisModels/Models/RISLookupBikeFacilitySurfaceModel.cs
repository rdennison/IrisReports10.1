...
{
    //[IrisGrid("~/API/RISLookupBikeFacilitySurface/Read", "~/API/RISLookupBikeFacilitySurface/Create", "~/API/RISLookupBikeFacilitySurface/Update", "~/API/RISLookupBikeFacilitySurface/Destroy")]
    public sealed class RISLookupBikeFacilitySurfaceModel : ModelBase
    {
		[Key]
