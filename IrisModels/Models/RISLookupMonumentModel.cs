...
{
    //[IrisGrid("~/API/RISLookupMonument/Read", "~/API/RISLookupMonument/Create", "~/API/RISLookupMonument/Update", "~/API/RISLookupMonument/Destroy")]
    public sealed class RISLookupMonumentModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupMonument_Key { get; set; }
