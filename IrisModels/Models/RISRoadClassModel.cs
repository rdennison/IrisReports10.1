...
{
    [Report(Module = "Road Inventory", Display = "Road Classifications", ListValue = "RISRoadClass")]
    [Security(Module = "Road Inventory", Display = "Road Classifications", ListValue = "RISRoadClass")]
    public sealed class RISRoadClassModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISRoadClass_Key { get; set; }
