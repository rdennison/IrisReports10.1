...
{
    //[IrisGrid("~/API/RISLookupManholeMaterial/Read", "~/API/RISLookupManholeMaterial/Create", "~/API/RISLookupManholeMaterial/Update", "~/API/RISLookupManholeMaterial/Destroy")]
    public sealed class RISLookupManholeMaterialModel : ModelBase
    {
		[Key]
