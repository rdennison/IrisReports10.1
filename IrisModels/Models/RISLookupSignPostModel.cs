...
{
    //[IrisGrid("~/API/RISLookupSignPost/Read", "~/API/RISLookupSignPost/Create", "~/API/RISLookupSignPost/Update", "~/API/RISLookupSignPost/Destroy")]
    public sealed class RISLookupSignPostModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupSignPost_Key { get; set; }
