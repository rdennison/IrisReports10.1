...
{
    //[IrisGrid("~/API/RISLookupIlluminationPole/Read", "~/API/RISLookupIlluminationPole/Create", "~/API/RISLookupIlluminationPole/Update", "~/API/RISLookupIlluminationPole/Destroy")]
    public sealed class RISLookupIlluminationPoleModel : ModelBase
    {
		[Key]
