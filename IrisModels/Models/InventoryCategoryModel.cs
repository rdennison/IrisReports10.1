...
{
    //[IrisGrid("~/API/InventoryCategory/Read", "~/API/InventoryCategory/Create", "~/API/InventoryCategory/Update", "~/API/InventoryCategory/Destroy")]
    public sealed class InventoryCategoryModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 InventoryCategory_Key { get; set; }
