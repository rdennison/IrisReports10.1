...
{
    //[IrisGrid("~/API/RISLookupCulvertCarried/Read", "~/API/RISLookupCulvertCarried/Create", "~/API/RISLookupCulvertCarried/Update", "~/API/RISLookupCulvertCarried/Destroy")]
    public sealed class RISLookupCulvertCarriedModel : ModelBase
    {
		[Key]
