...
{
    //[IrisGrid("~/API/RISLookupCatchBasinHistoryDisposalLocation/Read", "~/API/RISLookupCatchBasinHistoryDisposalLocation/Create", "~/API/RISLookupCatchBasinHistoryDisposalLocation/Update", "~/API/RISLookupCatchBasinHistoryDisposalLocation/Destroy")]
    public sealed class RISLookupCatchBasinHistoryDisposalLocationModel : ModelBase
    {
		[Key]
