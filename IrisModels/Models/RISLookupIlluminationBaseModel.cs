...
{
    //[IrisGrid("~/API/RISLookupIlluminationBase/Read", "~/API/RISLookupIlluminationBase/Create", "~/API/RISLookupIlluminationBase/Update", "~/API/RISLookupIlluminationBase/Destroy")]
    public sealed class RISLookupIlluminationBaseModel : ModelBase
    {
		[Key]
