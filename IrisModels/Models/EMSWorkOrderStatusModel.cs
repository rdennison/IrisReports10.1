...
{
    //[IrisGrid("~/API/EMSWorkOrderStatus/Read", "~/API/EMSWorkOrderStatus/Create", "~/API/EMSWorkOrderStatus/Update", "~/API/EMSWorkOrderStatus/Destroy")]
    public sealed class EMSWorkOrderStatusModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 EMSWorkOrderStatus_Key { get; set; }
