...
{
    //[IrisGrid("~/API/RISLookupSignalPedestrianHeadType/Read", "~/API/RISLookupSignalPedestrianHeadType/Create", "~/API/RISLookupSignalPedestrianHeadType/Update", "~/API/RISLookupSignalPedestrianHeadType/Destroy")]
    public sealed class RISLookupSignalPedestrianHeadTypeModel : ModelBase
    {
		[Key]
