...
{
    //[IrisGrid("~/API/RISLookupFederalFunctionalClass/Read", "~/API/RISLookupFederalFunctionalClass/Create", "~/API/RISLookupFederalFunctionalClass/Update", "~/API/RISLookupFederalFunctionalClass/Destroy")]
    public sealed class RISLookupFederalFunctionalClassModel : ModelBase
    {
		[Key]
