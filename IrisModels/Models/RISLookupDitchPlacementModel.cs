...
{
    //[IrisGrid("~/API/RISLookupDitchPlacement/Read", "~/API/RISLookupDitchPlacement/Create", "~/API/RISLookupDitchPlacement/Update", "~/API/RISLookupDitchPlacement/Destroy")]
    public sealed class RISLookupDitchPlacementModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupDitchPlacement_Key { get; set; }
