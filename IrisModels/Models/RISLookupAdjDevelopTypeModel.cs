...
{
    //[IrisGrid("~/API/RISLookupAdjDevelopType/Read", "~/API/RISLookupAdjDevelopType/Create", "~/API/RISLookupAdjDevelopType/Update", "~/API/RISLookupAdjDevelopType/Destroy")]
    public sealed class RISLookupAdjDevelopTypeModel : ModelBase
    {
		[Key]
