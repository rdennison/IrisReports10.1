...
{
    [Security(Module = "Accounts Receivable", Display = "Invoice Payment", ListValue = "ARSInvoiceAudit")]
    public sealed class ARSInvoiceAuditModel : ModelBase
    {
		[Key]
		...
		[Required(ErrorMessage = "Your {0} is required.")]
		[ForeignKey(typeof(ARSInvoiceModel), ForeignKeyDisplayField="NameDesc")]
		[FilterType(Dropdown = true)]
		[Display(Name = "ARS Invoice Key")]
		[IrisGridColumn(Width = 150)]
		[Aggregate(AllowAvg = false, AllowCount = true, AllowMax = false, AllowMin = false, AllowSum = false)]
