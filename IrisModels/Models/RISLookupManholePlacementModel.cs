...
{
    //[IrisGrid("~/API/RISLookupManholePlacement/Read", "~/API/RISLookupManholePlacement/Create", "~/API/RISLookupManholePlacement/Update", "~/API/RISLookupManholePlacement/Destroy")]
    public sealed class RISLookupManholePlacementModel : ModelBase
    {
		[Key]
