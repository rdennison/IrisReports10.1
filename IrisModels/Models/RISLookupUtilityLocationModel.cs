...
{
    //[IrisGrid("~/API/RISLookupUtilityLocation/Read", "~/API/RISLookupUtilityLocation/Create", "~/API/RISLookupUtilityLocation/Update", "~/API/RISLookupUtilityLocation/Destroy")]
    public sealed class RISLookupUtilityLocationModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISLookupUtilityLocation_Key { get; set; }
