...
{
    [Report(Module = "Road Inventory", Display = "Adopt a Road", ListValue = "RISAdoptARoad")]
    [Security(Module = "Road Inventory", Display = "Adopt a Road", ListValue = "RISAdoptARoad")]
    public sealed class RISAdoptARoadModel : ModelBase
    {
		[Key]
		[DbProperties(DatabaseType = SqlDbType.BigInt)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IrisGridColumn(Width = 150)]
		public Int64 RISAdoptARoad_Key { get; set; }
		...
		[DbProperties(DatabaseType = SqlDbType.VarChar, Size = 116)]
		[Required(ErrorMessage = "Your {0} is required.")]
		[IsExcludeSql]
		[FilterType(Text = true)]
