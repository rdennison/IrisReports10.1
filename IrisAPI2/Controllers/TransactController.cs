...
namespace IrisAPI2.Controllers
{
    public class TransactController : ApiController
    {
        ...
        [HttpGet]
        public IEnumerable<TimecardViewModel> GetAllGis(string filter, string key)
        {
            var user = validator.KeyValidator(key);
            List<TimecardViewModel> transaction = new List<TimecardViewModel>();
            ...
            //            var culvertInfo = _coreService.LoadDataSet<TransactModelObject>(countyKey, dataBase, true);
            ...
            //            {
            //                if (culvertInfo.Tables[i].TableName == "TransactModel")
            //                {
            ...
            //                        TimecardViewModel g = new TimecardViewModel
            //                        {
