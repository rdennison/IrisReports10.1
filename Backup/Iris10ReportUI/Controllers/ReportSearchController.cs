...
namespace Iris10ReportUI.Controllers
{
    public class ReportSearchController : Controller
    {
        ...
        private List<SqlWhere> CreateWheres(string searchString, List<SqlWhere> searches)
        {
            ...
            searches.Add(new SqlWhere(null, null, "RPTReportListByUser", "ReportName", '%' + searchString + '%', null, SqlWhereComparison.SqlComparer.Like, SqlWhereAndOrOptions.SqlWhereAndOr.Or));
            ...
            searches.Add(new SqlWhere(null, null, "RPTReportListByUser", "TagList", '%' + searchString + '%', null, SqlWhereComparison.SqlComparer.Like, SqlWhereAndOrOptions.SqlWhereAndOr.Or));
