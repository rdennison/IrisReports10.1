                ...
                if (userInfo != null)
                {
                    ...
                    if (userInfo.LoginChangePassword.HasValue ? !userInfo.LoginChangePassword.Value : false)
                    {
                        ...
                        if (sessionCookie != null)
                        {
                            ...
                            LookupValueHelper lookup = new LookupValueHelper();
                            UserDefinedFieldHelper userFields = new UserDefinedFieldHelper();
                            userFields.GenerateUserDefinedLists();
                            lookup.CreateLookupList();
